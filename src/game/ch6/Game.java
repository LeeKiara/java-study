...
class GameFrame extends JFrame implements KeyListener, Runnable{
	...
	// 윈도창 초기화
	public void init(){
		setTitle("To make shooting game"); // 윈도 타이틀
		...
		// 이미지 로딩
		characterImg = new ImageIcon(this.getClass().getResource("f15k.png")
			).getImage();
		
		missileImg = new ImageIcon(this.getClass().getResource("Missile.png")
			).getImage();
		
		enemyImg = new ImageIcon(this.getClass().getResource("enemy.png")
			).getImage();		
	}	
...
//		System.out.println("f_width:"+f_width+", f_height:"+ f_height);
