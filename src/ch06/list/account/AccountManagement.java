...
public class AccountManagement {
    ...
    // 배열을 Arraylist로 변경
    private List<Account> accountList;  // 계좌 List
    ...
    public AccountManagement() {
        accountList = new ArrayList<>(); // 계좌목록 List 생성
//        scanner = new Scanner(System.in);
    ...
    public void addAccount(String accountNumber, double balance) {
        ...
        System.out.println("계좌가 추가 되었습니다. (계좌번호 : "+accountNumber+", 입금액: "+balance+")");
    ...
    public void showAccountList() {
        ...
        for (Account oneAccount : accountList) {
            System.out.println("계좌번호 : [" + oneAccount.getAccountNumber() + "], 잔액: [" + oneAccount.getBalance() + "]");
        }
    }
    ...
    private Account findAccount(String accountNumber) {
        ...
        for (Account oneAccount : accountList) {
            //입력받은 계좌번호가 계좌 객체의 계좌번호와 동일할 경우 계좌객체 리턴
            if(oneAccount.getAccountNumber().equals(accountNumber))    {
                return oneAccount;
            }
        }
